...
import com.example.SBNZ.security.auth.RestAuthenticationEntryPoint;
import com.example.SBNZ.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        ...
        web.ignoring().antMatchers(HttpMethod.POST, "/auth/log-in", "/auth/activate", "/auth/register");
